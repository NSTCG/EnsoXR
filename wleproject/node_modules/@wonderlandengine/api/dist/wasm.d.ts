...
export declare class WASM {
    ...
    /** Source to load each image in {@link _images}/ */
    _imageSources: (string | Blob | null)[];
    /** Component instances. */
    private _components;
    /** Component Type info. */
...
export interface WASM {
    ...
    _wl_set_jobUpdate_callback: (cbPtr: number) => void;
    ...
    _wl_xr_init: (viewCount: number, useLayers: boolean, isMultisampled: boolean) => void;
    _wl_xr_focus: () => void;
    _wl_xr_blur: () => void;
    _wl_xr_hide: () => void;
    _wl_xr_exit: () => void;
    ...
    _wl_scene_create_chunked_end_queued: (index: number) => void;
    ...
    _wl_scene_environment_bake: (index: number) => number;
    ...
    _wl_scene_set_probeVolumeScenario: (index: number, scenarioId: number) => void;
    _wl_scene_get_probeVolumeScenario: (index: number) => number;
    _wl_set_loading_screen_progress: (ratio: number) => void;
    _wl_glTF_scene_create: (extensions: boolean, generateSimpleTangents: boolean, async: boolean, ptr: number, ptrEnd: number) => number;
    ...
    _wl_collision_component_get_visualize: (id: number) => number;
    _wl_collision_component_set_visualize: (id: number, visualize: boolean) => void;
    ...
    _wl_view_component_get_directionForScreenPosition: (id: number, x: number, y: number, ptr: number) => void;
    ...
    _wl_particleEffect_component_get_ids: (id: number) => number;
    _wl_particleEffect_component_get_transforms: (id: number) => number;
    _wl_particleEffect_component_get_scalings: (id: number) => number;
    _wl_particleEffect_component_get_lifetimes: (id: number) => number;
    _wl_particleEffect_component_get_colors: (id: number) => number;
    _wl_particleEffect_component_get_instanceData: (id: number) => number;
    _wl_particleEffect_component_update: (id: number, count: number) => void;
    _wl_particleEffect_component_spawnParticles: (id: number, count: number, lifetime: number, replacementPolicy: number) => number;
    _wl_particleEffect_component_aliveCount: (id: number) => number;
    ...
    _wl_physx_component_get_visualize: (id: number) => number;
    _wl_physx_component_set_visualize: (id: number, visualize: boolean) => void;
    ...
    _wl_image_destroy: (index: number) => number;
    ...
    _wl_probeVolumeScenario_find: (filename: number) => number;
    _wl_probeVolumeScenario_loaded: (index: number) => number;
    _wl_resource_count: (type: number) => number;
    _wl_resource_destroyed: (type: number, index: number) => number;
    _wl_resource_originScene: (type: number, index: number) => number;
    ...
    _wl_animationGraph_sampler_set_playbackSpeed: (id: number, index: number, speed: number) => void;
    _wl_animationGraph_create1DBlend: (animsPtr: number, animCount: number) => number;
    _wl_particleEffect_create: (maxCount: number, meshId: number, materialId: number, colors: boolean, instanceData: boolean) => number;
    _wl_particleEffect_get_maxCount: (index: number) => number;
    _wl_particleEffect_destroy: (index: number) => void;

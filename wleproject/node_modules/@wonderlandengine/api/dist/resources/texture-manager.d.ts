...
export declare class TextureManager extends ResourceManager<Texture> {
    ...
    static fetchImage(src: string | Blob, crossOrigin?: string): Promise<HTMLImageElement>;
    static fetchImageBitmap(src: string | Blob, options: Partial<ImageBitmapOptions>): Promise<ImageBitmap>;
    /**
